...
public class ShaderProgram
{
	...
	public void setUniform(String uniformName, Material material)
	{
		...
		{
			setUniform(uniformName + ".hasTexture", 1);
		}
		else
		{
			setUniform(uniformName + ".hasTexture", 0);
		}
	}

	public void setTextObjectUniform(Material material, Matrix4f projModelMatrix)
	{
		setUniform("projModelMatrix", projModelMatrix);
		setUniform("color", material.getAmbientColor());
